  ...
  head() {
    return {
      ...
      meta: [
        ...
        { src: 'http://example.com/xyz.jpg', alt: 'xyz' },
        { property: 'og:type', content: 'article' },
        { property: 'og:title', content: 'TITLE OF YOUR POST OR PAGE' },
        { property: 'og:description', content: 'DESCRIPTION OF PAGE CONTENT' },
        { property: 'og:image', content: 'http://example.com/xyz.jpg' },
        {
          property: 'og:url',
        ...
        { name: 'twitter:image', content: 'http://example.com/xyz.jpg' },
        {
          name: 'twitter:site',
          content: process.env.BASE_URL + this.$route.path
        },
